...
- Create and manage public or private polls
- Invite candidates to participate in the polls
- See live results and updates in real time
...
1. Clone the repository:
   ...
   ```shell
   git clone https://github.com/your-username/sirkle-ask-client.git
